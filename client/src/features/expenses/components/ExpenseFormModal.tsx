  ...
  const dateConstraints = useMemo(() => {
    ...
    const max = selectedBudget
      ? selectedBudget.expireDate.split("T")[0] < today
        ...
        : today
      : today;
    const min = selectedBudget
      ? selectedBudget.startingDate.split("T")[0]
      : undefined;
          ...
          <div>
            ...
            {selectedBudget ? (
              <button
                type="button"
                onClick={() =>
                  setFormState((current) => ({ ...current, budgetId: "" }))
                }
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: `${selectedBudget.category.color ?? "#94a3b8"}18`,
                  }}
                >
                  {(() => {
                    const Icon = getCategoryIcon(
                      selectedBudget.category.name,
                      selectedBudget.category.tags,
                    );
                    return (
                      <Icon
                        size={16}
                        style={{
                          color: selectedBudget.category.color ?? "#94a3b8",
                        }}
                      />
                    );
                  })()}
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-[11px] text-gray-400">
                    Rs.
                    {Math.max(
                      selectedBudget.amount - (selectedBudget.spendAmount ?? 0),
                      0,
                    ).toLocaleString()}{" "}
                    remaining of Rs.{selectedBudget.amount.toLocaleString()}
                  </p>
                </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p
                            className={`mt-0.5 text-[10px] font-mono ${isFull ? "text-red-400" : "text-gray-400"}`}
                          >
                            {isFull
                              ? "Budget full"
