...
const employmentStatuses: EmploymentStatus[] = [
  ...
  },
  {
    ...
    label: "Self-Employed",
    icon: Building2,
    desc: "Freelancer, business owner",
  },
  {
    id: "student",
    label: "Student",
    icon: GraduationCap,
    desc: "College, university, or school",
  },
  {
    id: "unemployed",
    label: "Unemployed",
    icon: User,
    desc: "Currently seeking work",
  },
  {
    id: "retired",
    label: "Retired",
    icon: Award,
    desc: "No longer actively working",
  },
];
      ...
      <div className="max-w-4xl mx-auto py-6">
        <div className="bg-white rounded-2xl border border-gray-100 p-6 text-center">
          ...
          <p className="text-gray-500 text-sm mt-2">
            We couldn&apos;t find your profile. You can retry or create a
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm mt-0.5">
          Your personal information and financial identity
        </p>
      </div>
        ...
        <div className="relative flex items-start gap-5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-white/50 text-sm mt-0.5">
              {email} · {phoneNumber || "+977 9828075695"}
            </p>
            <div className="flex items-center gap-2 mt-3 flex-wrap">
              ...
              <span className="flex items-center gap-1.5 text-[11px] px-2.5 py-1 rounded-full bg-white/8 text-white/60">
                <MapPin size={11} />{" "}
                {city ? `${city}, ${country || "N/A"}` : "Location not set"}
              </span>
              <span className="flex items-center gap-1.5 text-[11px] px-2.5 py-1 rounded-full bg-white/8 text-white/60">
                <Clock size={11} /> Member since{" "}
                {profile?.createdAt
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            {editingSection === "personal" ? (
              ...
              <p className="text-gray-800 text-sm px-3 py-2.5 bg-gray-50 rounded-xl border border-gray-100">
                {fullName || <span className="text-gray-300">Not set</span>}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {editingSection === "personal" ? (
              ...
              <p className="text-gray-800 text-sm px-3 py-2.5 bg-gray-50 rounded-xl border border-gray-100">
                {dob || <span className="text-gray-300">Not set</span>}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {editingSection === "personal" ? (
              <input
                ...
                className="w-full px-3 py-2.5 text-sm text-gray-800 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-[#00C950] focus:ring-2 focus:ring-[#00C950]/10 transition-all disabled:cursor-not-allowed"
              />
            ) : (
              <p className="text-gray-800 text-sm px-3 py-2.5 bg-gray-50 rounded-xl border border-gray-100">
                {email || <span className="text-gray-300">Not set</span>}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {editingSection === "personal" ? (
              ...
              <p className="text-gray-800 text-sm px-3 py-2.5 bg-gray-50 rounded-xl border border-gray-100">
                {phoneNumber || <span className="text-gray-300">Not set</span>}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {editingSection === "personal" ? (
              ...
              <p className="text-gray-800 text-sm px-3 py-2.5 bg-gray-50 rounded-xl border border-gray-100">
                {city || <span className="text-gray-300">Not set</span>}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {editingSection === "personal" ? (
              ...
              <p className="text-gray-800 text-sm px-3 py-2.5 bg-gray-50 rounded-xl border border-gray-100">
                {stateName || <span className="text-gray-300">Not set</span>}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {editingSection === "personal" ? (
              ...
              <p className="text-gray-800 text-sm px-3 py-2.5 bg-gray-50 rounded-xl border border-gray-100">
                {country || <span className="text-gray-300">Not set</span>}
              </p>
            )}
          </div>
        </div>
