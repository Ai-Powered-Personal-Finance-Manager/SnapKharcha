...
export const expenseSidebarStats = [
    ...
    { label: "Largest expense", value: "Rs.2,200" },
] as const;

export const expenseInsight =
    "You've spent Rs.2,200 in one food expense (Barbeque Nation). Spreading dining-out across smaller visits keeps your budget healthier.";