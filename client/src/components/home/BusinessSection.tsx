...
const businessFeatures = [
  { icon: "🧾", title: "AI Bill Generation", desc: "Generate professional customer bills and invoices with your business branding in seconds." },
  { icon: "📊", title: "Sales Analytics", desc: "Track daily, weekly, and monthly revenue. See top-selling items at a glance." },
  { icon: "👥", title: "Customer Records", desc: "Maintain customer purchase histories and identify loyal customers." },
  { icon: "📦", title: "Inventory Insights", desc: "Connect your stock to your sales data. Get alerts when items run low." },
  { icon: "💹", title: "Profit & Loss Overview", desc: "Auto-generated P&L summaries monthly — no accountant needed for basic overviews." },
  { icon: "🔔", title: "Smart Business Alerts", desc: "Get notified about unusual sales drops, high-expense days, or tax deadline reminders." },
];

export default function BusinessSection() {
  return (
    <section id="business" className="relative bg-[#01271E] py-28 px-6 lg:px-18 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1 max-w-xl lg:sticky top-28">
            ...
            >
              Not Just for{" "}
              <span className="text-[#00C950]">Individuals</span>
            </h2>
            ...
            <p
              ...
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              Restaurants, grocery shops, and retail stores can use SnapKharcha to generate
              customer bills, track revenue, and get AI-driven business insights — all from
              one clean dashboard.
            </p>
            ...
            <div className="space-y-3 mb-10">
              {[
                { emoji: "🍽️", label: "Restaurants & Cafés", desc: "Bill customers, track food costs" },
                { emoji: "🛒", label: "Grocery & Retail Shops", desc: "Inventory + sales in one place" },
                { emoji: "🏪", label: "Small Marts & Stores", desc: "Daily revenue & expense tracking" },
              ].map((type, i) => (
                <div
                  key={i}
