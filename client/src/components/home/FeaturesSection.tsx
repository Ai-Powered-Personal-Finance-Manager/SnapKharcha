...
const features = [
  {
    ...
    description: "Point your camera at any receipt. Our AI vision model reads the total, items, and merchant — auto-tagging it to the right category like Food, Travel, or Utilities instantly.",
    badge: "AI Vision",
  },
  {
    icon: (
    ...
    description: "Go beyond raw numbers. SnapKharcha analyzes your patterns and surfaces actionable insights — like 'Your dining out spending has doubled this month.'",
    badge: "Analytics",
  },
  {
    icon: (
    ...
    description: "Set custom budget limits per category. Get real-time push notifications when you're approaching or crossing your limits — before it's too late.",
    badge: "Real-time",
  },
  {
    icon: (
    ...
    description: "Beautiful charts and breakdowns of your monthly spending. Pie charts, bar graphs, and trend lines — a crystal-clear picture of where your money goes.",
    badge: "Dashboard",
  },
  {
    icon: (
    ...
    description: "Set financial goals — a trip, a gadget, an emergency fund. SnapKharcha tracks your progress, calculates how much to save monthly, and celebrates milestones.",
    badge: "Goals",
  },
  {
    icon: (
    ...
    description: "Log expenses manually with full category control, add notes, and attach images. Or import CSV/Excel bank statements with one click.",
    badge: "Flexible",
  },
];
...
export default function FeaturesSection() {
  return (
    <section id="features" className="relative bg-[#01271E] py-28 px-6 lg:px-18  overflow-hidden">
      {/* Top border */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p
            ...
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            From snapping bills to deep financial forecasting — SnapKharcha brings together
            the tools that actually make a difference in your financial life.
          </p>
        </div>
          ...
          {features.map((feature, i) => (
            ...
            >
              ...
              <div
                ...
                style={{ background: `radial-gradient(ellipse at top left, ${feature.iconBg}, transparent 70%)` }}
              />
              ...
              <div
                ...
                style={{ backgroundColor: feature.iconBg, border: `1px solid ${feature.iconBorder}`, color: feature.color }}
              >
                {feature.icon}
              </div>
              ...
              <span
                ...
                style={{ backgroundColor: feature.badgeBg, color: feature.color, border: `1px solid ${feature.badgeBorder}`, fontFamily: "'DM Sans', sans-serif" }}
              >
                {feature.badge}
              </span>
