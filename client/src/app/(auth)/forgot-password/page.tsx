...
export default function ForgotPasswordPage() {
  ...
  const strengthColor = ["", "#ef4444", "#f59e0b", "#0284c7", "#00C950"][
    passwordStrength
  ];

  const steps: Step[] = ["email", "otp", "reset"];
  const stepMeta = {
    email: { num: 1, label: "Enter Email", sub: "We'll send a 6-digit code" },
    otp: { num: 2, label: "Verify OTP", sub: "Check your inbox or spam" },
    reset: { num: 3, label: "New Password", sub: "Choose a strong password" },
  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[44%] relative overflow-hidden p-12 bg-[#01271E]">
        ...
        <Link
          href="/"
          className="flex items-center gap-2.5 relative z-10 w-fit"
        >
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          {step === "otp" && (
            <div>
              ...
              <div className="mb-6">
                <label
                  className="block text-xs font-semibold text-gray-500 mb-3 uppercase tracking-wider"
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
                  Verification Code
                </label>
              ...
              <div className="flex items-center justify-between mb-6 p-3.5 rounded-xl bg-gray-50 border border-gray-100">
                ...
                <button
                  ...
                  disabled={!canResend}
                  className={`text-xs font-semibold transition-all ${canResend ? "text-[#00C950] hover:underline cursor-pointer" : "text-gray-300 cursor-not-allowed"}`}
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
                  Resend OTP
                </button>
              ...
              <button
                onClick={() => simulate(() => setStep("reset"))}
          ...
          {step === "reset" && (
            <div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-3">
                          {[
                            ...
                            { label: "A-Z", pass: /[A-Z]/.test(newPassword) },
                            { label: "0-9", pass: /[0-9]/.test(newPassword) },
                            {
                              label: "!@#",
              ...
              <button
                onClick={() => simulate(() => setStep("success"))}
                disabled={
                  !newPassword ||
                  !confirmPassword ||
                  newPassword !== confirmPassword ||
          ...
          {step === "success" && (
            <div className="text-center">
              ...
              >
                ...
                to your SnapKharcha account with your new password.
              </p>
